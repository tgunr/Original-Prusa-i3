...
module y_motor_base(){
    ...
    {    
     union()
    {
    translate(v = [-15.5,-21,0]) cube(size = [31,42,10]);
    translate(v = [+15.5,-15.5,0]) cube(size = [5.5,31,10]);
    translate(v = [-15.5,-15.5,0]) cylinder(h = 10, r=5.5, $fn=50);
    translate(v = [-15.5,+15.5,0]) cylinder(h = 10, r=5.5, $fn=50);
    translate(v = [+15.5,-15.5,0]) cylinder(h = 10, r=5.5, $fn=50);
    translate(v = [+15.5,+15.5,0]) cylinder(h = 10, r=5.5, $fn=20);
...
module y_motor_holes(){
    ...
    // Screw head holes
		// BL
    	color("pink") translate(v = [-15.5,-15.5,-1]) cylinder(h = 10, r=1.8, $fn=20);
		// BR
		color("pink") translate(v = [+15.5,-15.5,-1]) cylinder(h = 10, r=1.8, $fn=20);
		// TL
		color("pink") translate(v = [-15.5,+15.5,-1]) cylinder(h = 10, r=1.8, $fn=20);
    ...
    // Screw holes
	// TL
		color("pink") translate(v = [-15.5,-15.5,7]) cylinder(h = 7, r=3.5, $fn=30);
	// TR
		color("pink") translate(v = [+15.5,-15.5,7]) cylinder(h = 7, r=3.5, $fn=30);
	// BL
    ...
    color("green") translate([18,45,15]) rotate([90,0,0]) cylinder(h = 10, r=0.8, $fn=20);
    color("green") translate([18,42.2,15]) rotate([90,0,0]) cylinder(h = 2, r1=1.2, r2=0.8, $fn=20);
 
    color("green") translate([18,45,24.5]) rotate([90,0,0]) cylinder(h = 10, r=0.8, $fn=20);
    color("green") translate([18,42.2,24.5]) rotate([90,0,0]) cylinder(h = 2, r1=1.2, r2=0.8, $fn=20);
   
    // endstop corner cutout
    translate([-10,30,28]) rotate([0,45,0]) cube([15, 19, 15]);	
    translate([-1,41,10])  cube([15, 5, 19]);	
    translate([27,33,10]) rotate([0,0,45]) cube([5, 5, 18]);	
    translate([7,28,10.01]) rotate([0,0,45]) cube([5, 5, 18]); 
    
    translate([24.5-2,36.5,17]) rotate([0,45,0]) cube([2, 6, 2]);	
